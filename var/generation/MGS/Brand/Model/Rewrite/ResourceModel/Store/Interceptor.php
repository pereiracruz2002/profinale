<?php
namespace MGS\Brand\Model\Rewrite\ResourceModel\Store;

/**
 * Interceptor class for @see \MGS\Brand\Model\Rewrite\ResourceModel\Store
 */
class Interceptor extends \MGS\Brand\Model\Rewrite\ResourceModel\Store implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'lookupBrandIds');
        if (!$pluginInfo) {
            return parent::lookupBrandIds($storeId);
        } else {
            return $this->___callPlugins('lookupBrandIds', func_get_args(), $pluginInfo);
        }
    }
