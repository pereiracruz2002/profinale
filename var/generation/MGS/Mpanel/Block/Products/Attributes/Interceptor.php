...
class Interceptor extends \MGS\Mpanel\Block\Products\Attributes implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getProductCollection($category, $attribute)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductCollection($category, $attribute);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeProductByCategories');
        if (!$pluginInfo) {
            return parent::getAttributeProductByCategories($categoryIds, $attribute);
        } else {
            return $this->___callPlugins('getAttributeProductByCategories', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'existAttribute');
        if (!$pluginInfo) {
            return parent::existAttribute($attribute);
        } else {
            return $this->___callPlugins('existAttribute', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function pmEscapeHtmlAttr($string, $escapeSingleQuote = true)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'pmEscapeHtmlAttr');
        if (!$pluginInfo) {
            return parent::pmEscapeHtmlAttr($string, $escapeSingleQuote);
        } else {
            return $this->___callPlugins('pmEscapeHtmlAttr', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function pmEscapeJs($string)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'pmEscapeJs');
        if (!$pluginInfo) {
            return parent::pmEscapeJs($string);
        } else {
            return $this->___callPlugins('pmEscapeJs', func_get_args(), $pluginInfo);
        }
    }
