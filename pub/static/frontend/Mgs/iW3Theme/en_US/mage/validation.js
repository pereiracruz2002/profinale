...
(function (factory) {
    ...
    var rules = {
        ...
        "letters-with-basic-punc": [
            ...
            'Apenas letras ou pontuações'
        ],
        "alphanumeric": [
            function (value, element) {
                return this.optional(element) || /^\w+$/i.test(value);
            },
            'Por favor, apenas letras, números, espaços ou underline.'
        ],
        "letters-only": [
            function (value, element) {
        ...
        "no-whitespace": [
            ...
            'Por favor, sem espaços em branco.'
        ],
        "zip-range": [
            function (value, element) {
        ...
        "time": [
            ...
            'Por favor, entre com um horário válido. (Entre 00:00 e 23:59).'
        ],
        "time12h": [
            function (value, element) {
                return this.optional(element) || /^((0?[1-9]|1[012])(:[0-5]\d){0,2}(\ [AP]M))$/i.test(value);
            },
            'Por favor, entre com um horário válido. (Entre 00:00am e 12:00pm).'
        ],
        "phoneUS": [
        ...
        "credit-card-types": [
            ...
            'Por favor, entre com um número de cartão válido.'
        ],
        "ipv4": [
            function (value, element) {
                return this.optional(element) || /^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/i.test(value);
            },
            'Por favor, entre com um endereço de IP v4 válido.'
        ],
        "ipv6": [
            function (value, element) {
            ...
            'Por favor, entre com um endereço de IP v6 válido.'
        ],
        "pattern": [
            function (value, element, param) {
        ...
        "validate-alphanum-with-spaces": [
            ...
            'Por favor, use apenas letras (a-z ou A-Z), números (0-9) ou espaços neste campo.'
        ],
        "validate-data": [
            function (v) {
                return $.mage.isEmptyNoTrim(v) || /^[A-Za-z]+[A-Za-z0-9_]+$/.test(v);
            },
            'Por favor, use apenas letras (a-z ou A-Z), números (0-9) ou espaços neste campo. O primeiro caractere deve ser uma letra.'
        ],
        "validate-street": [
            function (v) {
                return $.mage.isEmptyNoTrim(v) || /^[ \w]{3,}([A-Za-z]\.)?([ \w]*\#\d+)?(\r\n| )[ \w]{3,}/.test(v);
            },
            'Por favor, use apenas letras (a-z ou A-Z), números (0-9), espaços e "#" neste campo.'
        ],
        "validate-phoneStrict": [
            function (v) {
                return $.mage.isEmptyNoTrim(v) || /^(\()?\d{3}(\))?(-|\s)?\d{3}(-|\s)\d{4}$/.test(v);
            },
            'Por favor, digite um número válido (Ex: (11) 1122-3344).'
        ],
        "validate-phoneLax": [
            function (v) {
        ...
        "validate-fax": [
            ...
            'Por favor, entre com um número válido (Ex: (11) 1122-3344).'
        ],
        "validate-email": [
            function (v) {
                return $.mage.isEmptyNoTrim(v) || /^([a-z0-9,!\#\$%&'\*\+\/=\?\^_`\{\|\}~-]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z0-9,!\#\$%&'\*\+\/=\?\^_`\{\|\}~-]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*@([a-z0-9-]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z0-9-]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*\.(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]){2,})$/i.test(v);
            },
            'Por favor, digite um e-mail válido (Ex: nome@dominio.com.br).'
        ],
        ...
        "validate-password": [
            ...
            'Por favor, entre com 6 ou mais caracteres. Os espaços de saída serão ignorados.'
        ],
        "validate-admin-password": [
            ...
            'Por favor, digite 7 ou mais caracteres (letras ou números).'
        ],
            ...
            function (v, elm) {
                ...
                if (result == false) {
                    validator.passwordErrorMessage = $.mage.__(
                        "O mínimo de caracteres neste campo deve ser igual ou superior à %1." +
                        " Os espaços de saída serão ignorados."
                ...
                if (counter < passwordMinCharacterSets) {
                    result = false;
                    validator.passwordErrorMessage = $.mage.__(
                        "O mínimo de caracteres diferentes é %1." +
        ...
        "validate-number": [
            ...
            'Por favor, entre com um número válido neste campo.'
        ],
        "required-number": [
            function (v) {
                return !!v.length;
        ...
        "validate-cpassword": [
            ...
            'Por favor, certifique-se que as senhas são identicas.'
        ],
        "validate-identifier": [
            function (v) {
        ...
        "less-than-equals-to": [
            ...
            function () {
                var message = $.mage.__('Por favor, entre com um valor menor ou igual à %s.');
        ...
        "greater-than-equals-to": [
            ...
            function () {
                var message = $.mage.__('Por favor, entre com um valor maior ou igual à %s.');
        ...
        "validate-emails": [
            function (value) {
                ...
                return true;
            }, "Por favor, digite um e-mail válido separado por virgula (Ex: nome@dominio.com.br, email@dominio.com)."
        ],
        ...
        "validate-cc-type-select": [
             ...
             */
                ...
                return false;
            }, 'Tipo de cartão não bate com o número do cartão.'
        ],
        "validate-cc-number": [
            /**
        ...
        "validate-cc-cvn": [
             ...
             */
                ...
                return false;
            }, 'Por favor, digite um código de verificação válido.'
        ],
        "validate-cc-ukss": [
            /**
        ...
        'required-entry': [
            function (value) {
                return !$.mage.isEmpty(value);
            }, $.mage.__('Este campo é obrigatório')
        ],
        'not-negative-amount': [
            function (v) {
                if (v.length)
        ...
        'validate-per-page-value-list': [
            ...
            'Por favor, digite um número válido (Ex: 10, 20, 30)'
        ],
        ...
        'required-if-all-sku-empty-and-file-not-loaded': [
            function (value, element, params) {
                ...
                return valid;
            }, 'Por favor, entre com um SKU válido.'
        ],
    ...
    $.validator.messages = $.extend($.validator.messages, {
        required: $.mage.__('Este é um campo obrigatório.')
    });
